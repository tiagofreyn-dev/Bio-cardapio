-- ======================================================================
-- SCRIPT DE RESET COMPLETO DO BANCO DE DADOS (DO ZERO ABSOLUTO)
-- ======================================================================
-- Este script irá apagar todas as tabelas antigas (CASCADE) e recriar
-- a estrutura SaaS Multi-tenant perfeita com todas as colunas corretas.
-- Execute este script no SQL Editor do seu painel do Supabase para limpar
-- todos os dados legados e começar do zero absoluto sem erros.
